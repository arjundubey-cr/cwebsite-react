    ...
    <div className='container-fluid pl-3 pr-3'>
      <div className='intro'>
        ...
        <ol className='pl-3'>
          ...
          <li className='list-item'>
            International Association of Engineers membership
          </li>
          <li className='list-item'>
            Indian Society for Technical Education membership
          </li>
          <li className='list-item'>
          ...
          <li className='list-item'>
            Institute of Research Engineers and Doctors membership
          </li>
          <li className='list-item'>
            International Society for Research and Development membership
          </li>
        </ol>
      </div>
